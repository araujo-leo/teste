...
$router->get('/api/products/{id}/suppliers', [ProductSupplierController::class, 'getSuppliersByProduct'], [AuthMiddleware::class]);
...
$router->get('/api/suppliers/{id}/products', [ProductSupplierController::class, 'getProductsBySupplier'], [AuthMiddleware::class]);
